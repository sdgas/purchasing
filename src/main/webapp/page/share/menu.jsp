...
<div id="head" style="width: 1050px">
    ...
    <div
            style="width:400px;margin-top: 20px;margin-bottom: 0px;margin-left:340px;text-align: right">
    ...
    <%--导航菜单开始--%>
    <c:if
            test="${session.person.position.positionId!=4||session.person.remarks=='物料采购'}">
